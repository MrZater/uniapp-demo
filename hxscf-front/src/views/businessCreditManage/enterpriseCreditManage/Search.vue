                ...
                <el-form :inline="true" :model="formParams" label-width="90px" ref="searchForm" size="small">
                    <hidden-form>
                        ...
                        <el-form-item class="br-form-item-label" label="企业角色" prop="bizRoles">
                            <el-select v-model="formParams.bizRoles" placeholder="请选择企业角色" filterable class="br-select">
                        ...
                        <template slot="hidden">
                            ...
                            <el-form-item class="br-form-item-label" label="资信到期日" prop="endTime">
...
export default class Search extends Vue {
    ...
    @enterpriseCreditManage.Action orgListFN; // 根据组织机构查询业务部门
    @enterpriseCreditManage.State orgList; // 业务部门
    @enterpriseCreditManage.Mutation saveOrgList; // 业务部门
    ...
    search(): void {
        let params = {
            ...
            endDate: this.formParams.createTime[1]
                ...
                : "",
            beginDay: this.formParams.endTime[0]
                ? this.formParams.endTime[0]
                : "",
            endDay: this.formParams.endTime[1]
