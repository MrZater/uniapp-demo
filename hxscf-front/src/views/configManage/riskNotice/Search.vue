...
-->
<template>
    <renderBtn code="risk_notice_set_sel">
        <search-wrapper>
            <template slot="default">
                <el-form :inline="true" :model="formParams" label-width="90px" ref="searchForm" size="small" @submit.native.prevent>
                    <el-form-item class="br-form-item-label" label="风险通知主题" prop="messageTitle">
                        <el-input class="br-input" placeholder="请输入风险通知主题" v-model.trim="formParams.messageTitle"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item class="br-form-item-label" label="创建时间" prop="time">
                        <el-date-picker v-model="formParams.time" class="br-datepicker" type="daterange" value-format="yyyy-MM-dd" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
                        </el-date-picker>
                    </el-form-item>
                    <el-form-item class="br-form-item-label" label="通知方式" prop="messageType">
                        <el-select v-model="formParams.messageType" placeholder="请选择通知方式" filterable multiple collapse-tags class="br-select">
