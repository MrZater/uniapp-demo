<template>
    <B-dialog :title="dialogType=='add'?'新增':'编辑'" :visible="dialogVisible" width="460px" @close="handleCancel">
        <el-form :model="dialogForm" :rules="rules" ref="forms" label-width="100px" size="small">
            ...
            <el-form-item class="br-form-item-label" label="选项英文" prop="dictCode">
                <el-input class="br-input-large" placeholder="请输入选项英文" v-model.trim="dialogForm.dictCode" :disabled="dialogType == 'edit'"></el-input>
            </el-form-item>
