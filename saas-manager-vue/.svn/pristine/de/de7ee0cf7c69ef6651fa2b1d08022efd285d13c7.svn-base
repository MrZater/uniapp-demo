        ...
        <el-card>
          ...
          >
            ...
            <el-form-item
              ...
              prop="name"
            >
              <el-input v-model="loginMsgForm.name" />
            </el-form-item>
            <!-- 注册邮箱 -->
            ...
            <el-form-item
              ...
              prop="company"
            >
              <el-input v-model="loginMsgForm.company" />
            </el-form-item>
            <!-- 联系人 -->
            <el-form-item
              label="联系人:"
              prop="contact"
            >
              <el-input v-model="loginMsgForm.contact" />
            </el-form-item>
            <!-- 手机号码 -->
            <el-form-item
              label="手机号码:"
              prop="mobile"
            >
              <el-input v-model="loginMsgForm.mobile" />
            </el-form-item>
            <el-form-item
              label="主营应用:"
              prop="mainApp"
            >
              <el-input v-model="loginMsgForm.mainApp" />
            </el-form-item>
            <el-form-item
              label="了解途径:"
              prop="learnWay"
  ...
  methods: {
    ...
    getUserMsg() {
      ...
      if (roles === 'SUPER_ADMIN') {
        ...
        roles = '媒体'
      } else if (roles === 'BUSINESS_DIRECTOR') {
        roles = '商务总监'
      } else if (roles === 'OPERATOR_DIRECTOR') {
        roles = '运营总监'
      } else if (roles === 'TECHNOLOGY') {
        roles = '技术'
      } else if (roles === 'FINANCIAL') {
        roles = '财务'
      } else if (roles === 'MANAGEMENT') {
        roles = '管理层'
      } else if (roles === 'ADVANCED_OPERATOR') {
        roles = '高级运营'
      }
