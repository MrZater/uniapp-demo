...
"
    ...
    >
      ...
      >
        ...
        <el-form-item label="图标">
          ...
          <span
            style="color: red"
          >请上传png/jpgjpeg图片，宽高比1:1，小于200KB</span>
        </el-form-item>
      </el-form>
      <span
        v-if="allowOperate"
    ...
    >
      ...
      >
        ...
        <el-button
          type="primary"
          @click="addplacehandleSubmitForm"
        >确定</el-button>
      </span>
    </el-dialog>
    ...
    >
      ...
      >
        <el-button
          type="primary"
          @click="dialogPlatLinkVisible = false"
        >确认</el-button>
      </span>
    </el-dialog>
  </div>
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      if (row.iconUrl && row.iconUrl.includes('.')) {
        this.temp.iconUrl = this.$store.getters.resourceUrl + row.iconUrl
      } else {
...
::v-deep.app-container .el-upload--picture-card {
  width: 100px;
  height: 100px;
  display: flex;
