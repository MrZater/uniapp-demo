    ...
    >
      ...
      >
        ...
        <!-- <el-form-item
          ...
          v-if="$store.getters.roles[0] == 'SUPER_ADMIN'&&temp.position==3"
        >
          <el-radio v-model="temp.closeButtonType" :label="'A'"
            >一直显示</el-radio
          >
          <el-radio v-model="temp.closeButtonType" :label="'B'"
            >n秒后显示</el-radio
          >
        </el-form-item>
        <el-form-item
          v-if="temp.closeButtonType == 'B'"
          label="显示时间"
          prop="countDown"
        >
          <el-input-number
          ...
          />
          <span style="marginLeft:5px">s后</span>
        </el-form-item>
        <el-form-item v-if="temp.position==3" label="关闭按钮大小" prop="buttonSize">
          <el-input-number
            :min="0"
            :max="100"
        ...
        <el-form-item
          v-if="temp.position == 5"
          label="服务端激励回调"
          prop="serverVerify"
        >
          <el-switch
            v-model="temp.serverVerify"
            :active-value="1"
            :inactive-value="0"
            active-color="#13ce66"
        ...
        <el-form-item
          v-if="temp.serverVerify == 1 && temp.position == 5"
          label="激励名称"
          prop="rewardName"
        >
          <el-input
            v-model="temp.rewardName"
            placeholder="请输入激励名称"
          />
        </el-form-item>
        <el-form-item
        ...
        >
          <el-input
            v-model.number="temp.rewardCount"
            placeholder="请输入激励数量"
          />
        </el-form-item>
        <el-form-item
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        rewardName: [
          { required: true, message: "请输入激励名称", trigger: "blur" },
        ],
        rewardCount: [
          { required: true, message: "请输入激励数量", trigger: "blur" },
          { required: true, validator: countValidator, trigger: "blur" },
        ],
        callbackUrl: [
  ...
  methods: {
    ...
    changePosition(val) {
      if (this.dialogType == 0) {
        let md = md5(
          "" + new Date().getTime(),
          this.temp.appId ? this.temp.appId : ""
        );
        this.temp.secKey = md;
      }
    },
