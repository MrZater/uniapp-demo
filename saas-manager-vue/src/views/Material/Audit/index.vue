    ...
    <div class="search">
      <div class="search_top">
        <el-row :gutter="10">
          ...
          <el-col
            v-if="$store.state.user.roles[0] !== 'AUDITOR'"
            :span="4"
          >
            <CustSelectApp
              :word="'审核人员'"
              :width="450"
              :all-data="auditUserList"
            ...
            <div class="material_box">
              <div class="image">
                ...
                <div class="image_box">
                  <img
                    v-if="item.type === 1"
                    v-lazy="hadleHttps(item.creativeUrl)"
                    alt=""
                    :src="hadleHttps(item.creativeUrl)"
        ...
        <div class="details_box">
          <div class="left">
            <video
              ...
              controls
              :src="hadleHttps(detailsinfo.creativeUrl)"
            />
            <img
          ...
          <div class="right">
            <div class="box">
              ...
              <p>
                <span class="title">广告源：</span>{{ detailsinfo.platName }}
              </p>
              <p>
                <span class="title">素材标题：</span>{{ detailsinfo.title }}
              </p>
              <p class="description">
                <span class="title">素材描述：</span>{{ detailsinfo.description }}
              </p>
              <p class="downloadUrl">
                <span class="title">下载地址：</span><a
                  target="_blank"
                  :href="detailsinfo.downloadUrl"
                >{{
                  detailsinfo.downloadUrl
                }}</a>
              </p>
              <p class="landingPage">
                <span class="title">落地页：</span><a
                  target="_blank"
                  :href="detailsinfo.landingPage"
                >{{
                  detailsinfo.landingPage
                }}</a>
              </p>
              <p class="tags">
                <span class="title">标签：</span><WordTransfer
