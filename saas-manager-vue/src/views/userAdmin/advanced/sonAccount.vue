  ...
  <div>
    ...
    <el-card class="table">
      <div class="top">
        ...
        >
          <p>维度</p>
          <el-checkbox v-model="showArr.app">
            <span>应用</span>
          </el-checkbox>
    ...
    >
      ...
      >
        ...
        >
          <el-select
            v-model="accountForm.businessId"
            placeholder="请选择"
          >
            <el-option
    ...
    >
      <el-form label-width="130px">
        ...
        <el-form-item label="聚合管理权限">
          <el-switch
            v-model="permissionsForm.aggregate"
            :active-value="1"
            :inactive-value="0"
            active-color="#13ce66"
            inactive-color="#ff4949"
