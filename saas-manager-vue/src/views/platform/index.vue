  ...
  <div class="app-container">
    ...
    >
      ...
      >
        ...
        <!-- <el-form-item
          v-if="temp.platId == '1008'"
          label="signKey"
          prop="signkey"
        >
          <el-input v-model="temp.signkey" placeholder="请输入signKey" />
        </el-form-item> -->
        ...
        <el-form-item
          v-if="temp.platId == '991' || temp.platId == '1008'"
          :label="
            temp.platId == '991'
              ? '密钥'
              : temp.platId == '1008'
...
export default {
  ...
  data() {
    ...
    const signKeyValidator = (rule, value, callback) => {
      if (!value || value === "") {
        return callback(new Error("请输入signKey"));
      }
    };
