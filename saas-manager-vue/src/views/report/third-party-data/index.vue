...
export default {
  ...
  methods: {
    ...
    async downloadTemplate() {
      ...
      let resp = await this.exportToExcel()
      await excel(resp, `三方数据模板.xlsx`)
      this.downloadTempLoading = false
    },
    // 媒体报表数据导出
    exportToExcel() {
      return request.post(
        '/report/downloadTemplate',
        {},
        {
          responseType: 'blob'
        }
